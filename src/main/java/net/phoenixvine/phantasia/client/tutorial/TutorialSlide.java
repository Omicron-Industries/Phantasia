...
public final class TutorialSlide {
    ...
    public record Highlight(float relX, float relY, float relW, float relH, @Nullable String label) {
        public Highlight(float rx, float ry, float rw, float rh) { this(rx, ry, rw, rh, null); }
    }
    ...
    @Nullable public final MockRenderer mock;
    ...
    public static Builder of(String title, String text) { return new Builder(title, text); }
    ...
    public static final class Builder {
        ...
        private Builder(String title, String text) { this.title = title; this.text = text; }

        public Builder mock(MockRenderer r) { this.mock = r; return this; }
        ...
        public TutorialSlide build() { return new TutorialSlide(this); }
    }
}
