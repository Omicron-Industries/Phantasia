...
public class PhantasiaVoidChunkGenerator extends ChunkGenerator {
    ...
    public static final ResourceLocation CODEC_KEY = new ResourceLocation("phantasia", "void");

    // Codec takes no parameters — the generator is completely stateless.
    public static final Codec<PhantasiaVoidChunkGenerator> CODEC = RecordCodecBuilder.create(instance -> instance
